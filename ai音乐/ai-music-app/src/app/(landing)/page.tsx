  ...
  return (
    <PublicShell>
      <main>
        ...
        <section className="cooperation-section page-section"><div className="cooperation-visual"><Image src={placeholderMedia.scene} alt="校园合作场景占位图" width={900} height={620} /><span>真实课堂素材待补充</span></div><div className="cooperation-copy"><span className="eyebrow dark">FOR SCHOOLS</span><h2>把一间教室，变成一座小型创作实验室。</h2><p>为学校提供可落地的课程、课堂账号和 AI 工具能力。学生完成当堂任务，学校不需要建立学生个人云端档案。</p><div className="check-list"><span>✓ 课程进校与社团活动</span><span>✓ 每校共享课堂账号</span><span>✓ 课堂成本和并发保护</span></div><Link href="/school-cooperation" className="button button-dark">查看合作方式</Link></div></section>
