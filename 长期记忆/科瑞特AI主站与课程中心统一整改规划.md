...
- `[NEEDS-CONFIRM / Course, work and tool model proposal]` 已新增《课程公告作品与AI工具模型确认提案》，说明 `CourseAnnouncement`、`WorkCourseContext`、`AiTool` 的最小字段、服务端权限、默认行为和迁移边界；未获得项目负责人确认前不得创建模型、迁移、全局工具启停或课程作品关联。
